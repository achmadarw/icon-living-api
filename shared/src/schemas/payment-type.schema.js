...
exports.updatePaymentTypeSchema = exports.createPaymentTypeSchema = exports.paymentTypeCategorySchema = void 0;
const zod_1 = require("zod");
exports.paymentTypeCategorySchema = zod_1.z.enum(['IPL', 'DONATION', 'OTHER']);
exports.createPaymentTypeSchema = zod_1.z.object({
    ...
    category: exports.paymentTypeCategorySchema.default('IPL'),
    requiresPeriod: zod_1.z.boolean().default(true),
});
